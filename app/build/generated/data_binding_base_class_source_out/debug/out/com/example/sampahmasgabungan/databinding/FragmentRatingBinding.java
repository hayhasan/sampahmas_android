...
public final class FragmentRatingBinding implements ViewBinding {
  ...
  private FragmentRatingBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentRatingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRatingBinding((RelativeLayout) rootView, imageView);
    }
