...
public final class FragmentDeliveryBinding implements ViewBinding {
  ...
  private FragmentDeliveryBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentDeliveryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDeliveryBinding((RelativeLayout) rootView, imageView);
    }
